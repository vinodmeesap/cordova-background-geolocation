...
| [`locationUpdateInterval`](#param-integer-locationupdateinterval) | `Integer` | Required | `1000`| Set the desired interval for active location updates, in milliseconds.
...
| [`fastestLocationUpdateInterval`](#param-integer-fastestlocationupdateinterval) | `Integer` | Optional | `1000` | Explicitly set the fastest interval for location updates, in milliseconds.
